...
netsh interface ip add dns name="本地连接" 222.73.##.## index=1
netsh interface ip add dns name="本地连接" 58.215.##.## index=2
netsh interface ip add dns name="本地连接 2" 222.73.##.## index=1
netsh interface ip add dns name="本地连接 2" 58.215.##.## index=2
netsh interface ip add dns name="本地连接 3" 222.73.##.## index=1
netsh interface ip add dns name="本地连接 3" 58.215.##.## index=2
netsh interface ip add dns name="本地连接 4" 222.73.##.## index=1
netsh interface ip add dns name="本地连接 4" 58.215.##.## index=2
netsh interface ip add dns name="本地连接 5" 222.73.##.## index=1
netsh interface ip add dns name="本地连接 5" 58.215.##.## index=2
